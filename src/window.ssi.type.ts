...
export interface BitcoinSharedSecret {
  ...
  sender: string; // The Nostr public key of the person who encrypted the secret. It's the hex format.
  receiver: string; // The Nostr public key of the person with whom the secret is shared. It's the hex format.
}
